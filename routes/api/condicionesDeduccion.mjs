...
router.post('/:id_tipo_deduccion', [validateSchema(createCondicionesDeduccionSchema)], Call(CondicionesDeduccionController.store))
router.put('/:id_condicion_descuento', [validateSchema(updateCondicionesDeduccionSchema)], Call(CondicionesDeduccionController.update))
router.delete('/:id_condicion_descuento', [validateSchema(deleteCondicionesDeduccionSchema)], Call(CondicionesDeduccionController.delete))
