...
router.post('/', [], Call(TipoBonoController.store))
router.put('/:id_tipo_bono', [], Call(TipoBonoController.update))
router.delete('/:id_tipo_bono', [], Call(TipoBonoController.delete))
